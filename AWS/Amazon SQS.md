...
+ Unlimited throughput, scale horizontally and add more consumers for processing. (Standard Queue)![[www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851370.png]]
+ Unlimited number of messages
# Encryption
+ Encryption in transit through HTTPS/SSL.
+ Encryption at rest through KMS keys (SSE-SQS, SSE-KMS, similar to [[Amazon S3#Object Encryption|SSE-S3 and SSE-KMS]])
+ Client side encryption/decryption needs to be done by client.
# Security
+ [[IAM]] policies and SQS access policies (similar to [[Amazon S3#Bucket policy|S3 bucket policies]]).
...
+ If message processing is taking longer than the timeout, a consumer can add time to the _message visibility timeout_ by calling _ChangeMessageVisibility_ API. This prevents processing of duplicate messages.![[www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_21437606.png]]
...
+ When consumer processes the message, it knows to read the larger message in the S3 bucket and do the processing.![[www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_21437546.png]]

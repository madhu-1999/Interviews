...
# Applications
+ Data partitioning -> [Amazon DynamoDB](Amazon%20DynamoDB.md), Cassandra
+ CDN -> distribute static content evenly
+ [](Scaling.md#Load%20Balancer|Load%20balancers) -> distribute requests evenly to web/cache servers.
...
```
# Overview
+ [](Cloud%20Computing.md#Platform%20as%20a%20service(PAAS)|PAAS) , developer centric, high level (compared to [AWS CloudFormation](AWS%20CloudFormation.md)) service.
...
+ IAM permissions through [](AWS%20CloudFormation.md#^1b71a7|service%20roles).
+ Supported Platforms
...
+ __Environment__: 
	...
	+ Two types of environments:
		+ Web Server environment: The ELB load balances requests to the web servers.![www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851294](Assets/www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851294.png)
		+ Worker environment: Messages are put into the SQS queue and the workers pull messages from the queue for processing.![www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851294 (1)](Assets/www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851294%20(1).png)
...
+ Simple but not highly available, suitable for development purposes.![www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851294 (2)](Assets/www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851294%20(2).png)
...
+ Optionally, Multi-AZ RDS database instance with one master and standby instances.![www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851294 (3)](Assets/www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851294%20(3).png)
## Environment updates
### __All at once__
...
+ No additional cost
![www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851300](Assets/www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851300.png)
### __Rolling__
...
![www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851300 (1)](Assets/www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851300%20(1).png)
...
+ Good for prod
+ Some downtime, but limited to a single batch
![www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851300 (2)](Assets/www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851300%20(2).png)
### __Immutable__
...
+ Great for prod
![www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851300 (3)](Assets/www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851300%20(3).png)
...
+ Create a new environment (green) and deploy new version there.
	+ Use [](Amazon%20Route%2053.md#Weighted%20Routing|weighted%20routing) to split traffic between new and old environment.
...
![www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851300 (4)](Assets/www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851300%20(4).png)
...
+ Zero downtime, slow deployment
![www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851300 (5)](Assets/www.udemy.com_course_aws-certified-developer-associate-dva-c01_learn_lecture_11851300%20(5).png)
# Lifecycle Policy

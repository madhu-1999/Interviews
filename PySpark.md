...
The `parallelize()` method is used to take an existing collection in your driver program (like a Python list) and distribute it across the cluster to create a [[Apache Spark#RDDs|Resilient Distributed Dataset (RDD).]][^2]

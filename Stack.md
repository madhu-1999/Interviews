...
# Monotonic Stack
A [***monotonic stack***](https://www.geeksforgeeks.org/dsa/introduction-to-monotonic-stack-2/) is a special type of stack data structure where elements are kept in either ***increasing*** or ***decreasing*** order.

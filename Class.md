...
# 01:30:00
```
+ Objects are **mutable**. Refer [[Python/Functions#Pass by Reference or Pass by Value?|for more info]]
...
+ Constructor overloading done using [[Python/Functions#Default Arguments|default arguments]] and [[Python/Functions#Variable length arguments|variable length arguments]]
```python
class Person:

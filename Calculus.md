...
![[Pasted image 20260310232112.png]]
If $y = \frac{1}{4}x^2$ , then $\frac{dy}{dx} = \frac{1}{4}\times 2x = \frac{x}{2}$  
![[Pasted image 20260310233413.png]]
...
>2. The function does not have a [[#Limits|limit]] at that point 
>3. The function is not [[#Continuous functions|continuous]] (e.g., has a sudden jump) at a point
## ML Applications
...
![[Pasted image 20260311083202.png]]
...
![[Pasted image 20260311083857.png]]
...
![[_Users_madhulikasawant_Downloads_calculus-for-machine-learning-understanding-the-language-of-mathematics_compress.pdf.png]]
...
![[_Users_madhulikasawant_Downloads_calculus-for-machine-learning-understanding-the-language-of-mathematics_compress.pdf (1).png]]
>[!example]+
...
g(x) = \begin{cases}
 ...
 2, & \text{otherwise}
\end{cases}$$
> ![[Pasted image 20260312225204.png]]
...
It can also be defined as the **limit of the average rate of change**.
	...
	![[_Users_madhulikasawant_Downloads_calculus-for-machine-learning-understanding-the-language-of-mathematics_compress.pdf (2).png]]
...
Given the unit vectors $\hat{i},\hat{j},\hat{k}$ parallel to the x, y, z-axis respectively, we can write a three dimensional vector-valued function as: $$r(t) = x(t)\mathbf{\hat{i}} + y(t)\mathbf{\hat{j}} + z(t)\mathbf{\hat{k}}$$
 ![[_Users_madhulikasawant_Downloads_calculus-for-machine-learning-understanding-the-language-of-mathematics_compress.pdf (3).png]]
The derivative of $r(t)$ is given by $r ′ (t)$ computed as: $$r'(t) = x'(t)\mathbf{\hat{i}} + y'(t)\mathbf{\hat{j}} + z'(t)\mathbf{\hat{k}}$$![[_Users_madhulikasawant_Downloads_calculus-for-machine-learning-understanding-the-language-of-mathematics_compress.pdf (6).png]]
...
Its [[Linear Algebra#Determinant of Matrix|determinant]] of function $f$ is given by:
